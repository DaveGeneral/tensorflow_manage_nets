...
if __name__ == '__main__':
    ...
    with tf.Session() as sess:
        ...
        AEncode = AE.AEncoder(path_save_weight0, learning_rate=learning_rate, noise=noise_level)
        AEncode.build(x_batch, mask, noise_mode, [2048, 1024])
        sess.run(tf.global_variables_initializer())
    ...
    with tf.Session() as sess:
        ...
        # Default: path_save_weight_dual
        AEncode = AE.AEncoder(path_save_weight1, learning_rate=learning_rate, noise=noise_level)
        AEncode.build(x_batch, mask, noise_mode, [2048, 1024])
        sess.run(tf.global_variables_initializer())
    ...
    # 0: 40 por clase + 20 + 30 + 30
    # 1: 40 por clase + 20 + 30 + 30 + 30


    # 20 Epocas:
    # 379
    # 317
    # AC: 0.8364116094986808
    # [[276  28]
    #  [34  41]]

    # 379
    # 319
    # AC: 0.841688654353562
    # [[276  28]
    #  [32  43]]

    # 379
    # 318
    # AC: 0.8390501319261213
    # [[274  30]
    #  [31  44]]
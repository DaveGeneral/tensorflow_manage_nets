...
path = '../data/features_cifar10/'
path_data_train = [path+'output_train_relu6.csv']
path_data_test = [path+'output_l_relu6.csv']
...
def test_model(net, sess_test, objData):
    ...
    for i in range(objData.total_batchs_complete):
        ...
        # utils.save_layer_output(layer, label, name='Train_AE1_fc1', dir='../data/features_cifar10/')
